...
public class AgendaDAO {
	...
	public void incluir(Agenda to) {
		String sqlInsert = "INSERT INTO agenda(nome, endereco, telefone, email) VALUES (?, ?, ?, ?)";
	...
	public void excluir(Agenda to) {
		String sqlDelete = "DELETE FROM agenda WHERE nome = ?";
		try (Connection conn = ConnectionFactory.obtemConexao();
	...
	public Agenda carregar(Agenda to) {
		String sqlSelect = "Select * from agenda where nome = ?";
